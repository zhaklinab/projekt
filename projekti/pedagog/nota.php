...
<html>
  ...
  <body>
    <nav class="navbar navbar-default">
        ...
        <form  class="form-inline" method="post" action="shtonote.php">
          <center>
            <?php
    ...
    <?php
        $query2 = "SELECT s.em_Studenti,s.id_Studenti, p.id_Provimi
                  ...
                  Where p.id_Lenda = '$id_lenda' AND p.id_va ='$id_viti_akademik'";
                ...
                <?php
                 if (mysqli_num_rows($result) >0) {
                  ...
                  $result1 = mysqli_query($con, $query);
                    ...
                    <input type="hidden" name="id_va" value="<?php echo $id_viti_akademik;?>">
                    </tr>
                <?php
                  }
                } else {
