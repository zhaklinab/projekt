            ...
            <tbody>
             ...
             while($row = mysqli_fetch_assoc($result1)){
               ...
               $email= $row['Email'];
                 ...
                 echo "<tr><td>".$emri."</td><td>".$datelindje."</td><td> ".$email."</td>";
             ?>
                 <td>
                    <form action='ndrysho_student.php?id="<?php echo $row['id_Studenti']; ?>"' method="GET">
                      <input type="hidden" name="id_studenti" value="<?php echo $row['id_Studenti']; ?>">
                      <input type="submit" class="btn btn-primary" name="submit" value="Update"/>
                    </form>
                 </td>
                 <td>
                   <form action='fshi_student.php?id="<?php echo $row['id_Studenti']; ?>"' method="GET">
                      <input type="hidden" name="id_studenti" value="<?php echo $row['id_Studenti']; ?>">
