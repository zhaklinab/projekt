          ...
          <table class="table table-hover">
            ...
            <tbody>
             ...
             while($row = mysqli_fetch_assoc($result1)){
               $emertim = $row['Em_IAL'];
               $adresa = $row['Adresa'];
                 echo "<tr><td>".$emertim."</td><td>".$adresa."</td><td> "."</td><td>"."</td>";
             ?>
                 <td>
                    <form action='ndrysho_ial.php?id="<?php echo $row['id_IAL']; ?>"' method="GET">
                      <input type="hidden" name="id_ial" value="<?php echo $row['id_IAL']; ?>">
                      <input type="submit" class="btn btn-primary" name="submit" value="Update"/>
                    </form>
                 </td>
                 <td>
                   <form action='fshi_ial.php?id="<?php echo $row['id_IAL']; ?>"' method="GET">
                      <input type="hidden" name="id_ial" value="<?php echo $row['id_IAL']; ?>">
